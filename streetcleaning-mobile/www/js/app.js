        ...
        $rootScope.questionnaireWindow = function () {
            ...
            var authapi = {
                authorize: function (url) {
                    ...
                    var authUrl = 'https://in-app.cloudfoundry.welive.eu/html/index.html?app=' + Config.getAppName() + '&pilotId=Trento' + '&callback=' + Config.getRedirectUri() + '&lang=' + $translate.use().toUpperCase();
